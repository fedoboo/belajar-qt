...
if (!Function.prototype.bind) {
    Function.prototype.bind = function(aa) {
        var ba = [].slice, ca = ba.call(arguments, 1), self = this, da = function() {}, ea = function() {
            ...
            switch (c) {
              ...
              default:
                if (c >= 32) {
                    ...
                    this.lines[this.y][this.x] = c & 65535 | this.cur_attr << 16;
                    this.x++;
                    ua(this.y);
                }
                break;
            ...
            if (c >= 48 && c <= 57) {
                ...
                switch (c) {
                  ...
                  case 72:
                    {
                        ...
                        if (this.esc_params.length >= 2) Ba = this.esc_params[1] - 1; else Ba = 0;
                        if (Ca < 0) Ca = 0; else if (Ca >= this.h) Ca = this.h - 1;
                        if (Ba < 0) Ba = 0; else if (Ba >= this.w) Ba = this.w - 1;
                        this.x = Ba;
                        this.y = Ca;
                    }
                    break;
                  ...
                  case 109:
                    ...
                    break;
                  case 110:
                    this.queue_chars("[" + (this.y + 1) + ";" + (this.x + 1) + "R");
                    break;
                  default:
                    break;
                }
    ...
    switch (Da.keyCode) {
      ...
      default:
        if (Da.ctrlKey) {
            ...
            if (Da.keyCode >= 65 && Da.keyCode <= 90) {
                ta = "" + String.fromCharCode(Da.keyCode + 32);
            }
        }
        break;
    }
